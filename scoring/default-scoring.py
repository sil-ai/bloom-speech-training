...
def main():
    ...
    task = Task.init(
      ...
      task_name='ASR-default-model-scoring-' + str(int(time.time())), # task name of at least 3 characters
      task_type="testing",
      tags=None,
    ...
    for language in langs:
        ...
        with open('default_scores.txt', 'a') as f:
            f.write(f'{language}:\t{wer:.2f}\t{cer:.2f}\n')

        with open('default_sample_predictions.txt', 'a') as f:
