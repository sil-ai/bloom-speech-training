...
def main():
    ...
    task = Task.init(
      ...
      task_name='ASR-model-training-' + str(int(time.time())), # task name of at least 3 characters
      task_type="training",
      tags=None,
    ...
    def train():
        ...
        if "common_voice" in data_args.dataset_name or "sil-ai/bloom-speech" in data_args.dataset_name:
